...
<template>
  ...
  >
    ...
    <ComingSoon
      title="Payment FAQ coming soon"
      description="We are preparing answers about failed payments, refunds to original methods, and Razorpay receipt questions. Need help with a charge today? Contact us."
    />
  </StaticPageLayout>
</template>
